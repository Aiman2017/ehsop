...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="i<?= ASSETS?>/eshop/mages/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="i<?= ASSETS?>/eshop/mages/ico/apple-touch-icon-72-precomposed.png">
